...
public class ParamUtil {
    ...
    public static String getOrderId() {
        return 8 + (System.currentTimeMillis() + "" + acacAtomicLong.addAndGet(1)).substring(2);
    }
    ...
    public static boolean ifImg(String url){
        return isNotEmpty(url) && url.contains(".") &&".png.bmp.jpeg.jpg".contains(url.substring(url.lastIndexOf(".")));
    }
